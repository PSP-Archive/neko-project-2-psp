...
#define	SNDCSEC_INIT { semid = sceKernelCreateSema("sndcsec", 0, 1, 1, NULL); }
#define	SNDCSEC_TERM sceKernelDeleteSema(semid)
#define	SNDCSEC_ENTER sceKernelWaitSema(semid, 1, 0)
#define	SNDCSEC_LEAVE sceKernelSignalSema(semid,1)
